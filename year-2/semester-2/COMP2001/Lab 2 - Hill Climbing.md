...
In some cases, changing the hill climbing algorithm to accept moves off better OR equal values because it may choose a different neighbouring solution when there are multiple solutions of the same quality.